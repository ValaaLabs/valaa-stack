...
import Prophet, { MediaInfo, NarrateOptions } from "~/valaa-prophet/api/Prophet";

import { invariantifyObject, Logger, LogEventGenerator } from "~/valaa-tools";
...
export default class PartitionConnection extends LogEventGenerator {
  ...
  isTransient () { return this._partitionURI.protocol === "valaa-transient:"; }
