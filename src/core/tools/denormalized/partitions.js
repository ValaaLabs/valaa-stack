...
import Bard, { getActionFromPassage } from "~/core/redux/Bard";
import { PartitionURI, createPartitionURI, getPartitionAuthorityURIStringFrom,
    getPartitionRawIdFrom } from "~/core/tools/PartitionURI";
...
import traverseMaterializedOwnlings
    from "~/core/tools/denormalized/traverseMaterializedOwnlings";
