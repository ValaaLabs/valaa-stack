import { created, modified, removedFromFields, replacedWithinFields } from "~/core/command";
import getObjectTransient from "~/core/tools/denormalized/getObjectTransient";
import getObjectField, { getObjectRawField } from "~/core/tools/denormalized/getObjectField";
import { vRef, dRef } from "~/core/ValaaReference";
