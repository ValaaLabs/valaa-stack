...
import { Discourse } from "~/valaa-prophet";

import VALEK, { Kuery, dumpKuery } from "~/valaa-engine/VALEK";

import VrapperSubscriber from "~/valaa-engine/Vrapper/VrapperSubscriber";

import { LogEventGenerator, wrapError, dumpObject } from "~/valaa-tools";
...
export default class Cog extends LogEventGenerator {
  ...
  run (head: any, kuery: Kuery, options: any = {}) {
    try {
      ...
      throw wrapError(error, `During ${this.debugId({ suppressKueries: true })}\n .run(), with:`,
