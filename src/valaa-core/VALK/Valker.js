...
import { elevateFieldReference, elevateFieldRawSequence }
    from "~/valaa-core/tools/denormalized/FieldInfo";
...
import { VRef, isIdData } from "~/valaa-core/ValaaReference";

import coreBuiltinSteppers, { debugWrapBuiltinSteppers } from "~/valaa-core/VALK/builtinSteppers";
import Kuery, { dumpKuery, dumpScope, dumpObject } from "~/valaa-core/VALK/Kuery";
import { tryPackedField, packedSingular } from "~/valaa-core/VALK/packedField";
import { addStackFrameToError, SourceInfoTag } from "~/valaa-core/VALK/StackTrace";

import type Logger from "~/valaa-tools/Logger";
import { dumpify, wrapError } from "~/valaa-tools";
...
export default class Valker extends Resolver {
  ...
  _builtinSteppers: Object = coreBuiltinSteppers;
  ...
  setBuiltinSteppers (builtinSteppers?: Object) {
    this._builtinSteppers = builtinSteppers || coreBuiltinSteppers;
  }
